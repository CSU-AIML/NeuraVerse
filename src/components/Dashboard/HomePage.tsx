...
const HomePage = ({ isAdmin, onCreateProject, onExploreProjects }: HomePageProps) => {
  return (
    <div className="relative overflow-hidden w-full bg-slate-900/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-3xl">
      ...
      <div className="absolute top-0 left-0 w-1/2 h-1/2 bg-gradient-to-br from-blue-500/10 to-transparent blur-3xl rounded-3xl" />
      <div className="absolute bottom-0 right-0 w-1/2 h-1/2 bg-gradient-to-tl from-purple-500/10 to-transparent blur-3xl rounded-3xl" />
